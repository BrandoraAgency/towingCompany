                        ...
                        <b-row>
                            ...
                            <b-col>
                                <b-form-group id="input-group-2" label="First Name" label-for="input-first">
                                    <b-form-input id="input-first" v-model="form.firstName"  placeholder="Enter First Name"
                                        required></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col>
                                <b-form-group id="input-group-2"  label="Last Name" label-for="input-last">
                                    <b-form-input id="input-last" v-model="form.lastName" placeholder="Enter last Name" required></b-form-input>
                                </b-form-group>
                            </b-col>
                        </b-row>
                        <b-row>
                            ...
                            <b-col>
                                <b-col>
                                    <b-form-group id="input-group-2"  label="Password" label-for="input-pas">
                                        <b-form-input id="input-pass"  v-model="form.password" type="password" placeholder="Enter Password" required></b-form-input>
                                    </b-form-group>
                                </b-col>
                            </b-col>
                        </b-row>
